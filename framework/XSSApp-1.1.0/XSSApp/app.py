...
from .validation_utilities import (
    generate_regex_validator, is_valid_uploaded_file_name, generate_or_regex_validator)
...
VALIDATORS = {
    ...
    "email": generate_or_regex_validator([validation_utilities.MAIL_REGEX, validation_utilities.NAME_REGEX], "mail address"),
...
def add_message(args: dict):
    ...
    messages.append(UserMessage(result, is_admin))
